...
var VirtualScrollerComponent = (function () {
    ...
    VirtualScrollerComponent.prototype.calculateDimensions = function () {
        ...
        viewportHeight = scrollElement.clientHeight + 100;
        if(this.parentScroll instanceof Window && (document.scrollingElement instanceof HTMLElement || document.scrollingElement instanceof HTMLElement)){
    ...
    VirtualScrollerComponent.prototype.calculateViewport = function () {
        ...
        var newScrollLength = dimensions.scrollLength + 55;
        return {
